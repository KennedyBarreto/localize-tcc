...
if ( !isset($_SESSION['email']) and !isset($_SESSION['senha']) ) {
	...
	$query=mysqli_query($conexao,"SELECT*FROM comercio WHERE id_usuario='$id_usuario'");
	$dados2=mysqli_fetch_array($query);
	$id=$dados2['id_comercio'];
	if($id==$id_comercio){
		header('location:perfil-comercio4.php');
	}

	$resultado = mysqli_query($conexao,"SELECT*FROM comercio WHERE id_comercio ='$id_comercio'") or die ("Erro na seleção da tabela.");
...
<body>
                  ...
                  <nav> 
                        ...
                        <div class="menu">
                              <ul>
								    ...
								    <li><a href="metricas.php">Meu Comercio</a></li>
  ...
  ?> </div>
    ...
    while ($row = mysqli_fetch_array($result3)) {
		...
		echo " <div class='numbertext'> $tnoc / 6</div>";
  ...
  ?>
	...
	<div class="avaliacao">
		...
		<div class="menssagem2">
			<form method="post" action="efetuar-cadastro-comentario2.php">
