...
<body>
  ...
  ?> </p>
	...
	<div class="balls">
	<div class="star"><p><i class="fas fa-star"></i><b> <?PHP echo number_format((float)$media, 2, '.', ''); ?></p></div>
	<div class="coment"><p><i class="fas fa-comment"></i> <b><?PHP echo($num); ?></p></div>
	</div>
  ...
  ?>
	...
	<div class="alerta">
		...
		<p>Para avaliar estabelecimentos é necessario estar conectado a uma conta, <a href="login.php">Entre</a> ou <a href="cadastro-usuario.php">Crie</a> uma agora!</p>
	</div>
	...
	<div class="avaliacao">
		...
		<div class="menssagem2">
			<form>
				...
				<h3>&nbsp;</h3>
				<textarea name="message" type="text" id="message" placeholder="Menssagem"></textarea>
